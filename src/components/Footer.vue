  ...
  <footer class="bg-[#050203] text-white py-16">
    <div class="container mx-auto px-6">
      ...
      <div class="grid md:grid-cols-2 gap-16 mb-20">
        ...
        <img class="w-48" src="../assets/Image/Frame 36.svg" alt="WebStack Technology Logo">
      </div>
      ...
      <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-12 pb-12 border-b border-gray-800">
        <!-- Navigation Links -->
        <nav class="flex flex-wrap gap-8">
          ...
          <a href="#projects" class="text-gray-300 hover:text-white transition-colors">Work</a>
          <a href="#pricing" class="text-gray-300 hover:text-white transition-colors">Pricing</a>
          <a href="#faq" class="text-gray-300 hover:text-white transition-colors">Questions</a>
        </nav>

        <!-- Social Icons -->
        <div class="flex gap-4">
          <a href="#" class="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-white hover:text-gray-900 transition-colors">
